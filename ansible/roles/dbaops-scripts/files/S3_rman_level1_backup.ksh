...
LOGFILE="/u01/app/oracle/logs/rman/rman_${ORACLE_SID}_level1_backup_DataDomain_${BACKUP_START_TIME}.log"
...
RUN
{
	...
	backup incremental level 1 cumulative database format '%d_%s_%p_%T.bkp' tag '${ORACLE_SID}_L${BACKUP_LEVEL}_${BACKUP_START_TIME}';
